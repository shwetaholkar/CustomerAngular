...
import { MyTraining1121AngularDemoCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'MyTraining1121AngularDemo',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for MyTraining1121AngularDemo',
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        MyTraining1121AngularDemoCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule,
